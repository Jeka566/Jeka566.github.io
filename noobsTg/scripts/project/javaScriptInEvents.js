...
const scriptsInEvents = {
	...
	async E_menu_Event2_Act12(runtime, localVars)
	{

	},

	async E_menu_Event15_Act1(runtime, localVars)
	{
		p_adextra()
	},
	...
	async Achievements_Event5_Act1(runtime, localVars)
	{
		var count = 200;
		var defaults = {
		  origin: { y: 0.7 }
	...
	async Achievements_Event6_Act1(runtime, localVars)
	{
